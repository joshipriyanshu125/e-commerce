...
export {
    ...
    // Shipping
    courierAssignedTemplate,
    trackingGeneratedTemplate,
    packageDelayedTemplate,
    deliveryRescheduledTemplate,
    packageDeliveredTemplate,
    // Returns & Refunds
    returnRequestedTemplate,
    returnApprovedTemplate,
    returnRejectedTemplate,
    pickupScheduledTemplate,
    ...
    codConfirmedTemplate,
    // Wishlist
    backInStockTemplate,
    priceDroppedTemplate,
    limitedStockTemplate,
    flashSaleStartedTemplate,
    wishlistDiscontinuedTemplate,
    // Promotional
    newArrivalsTemplate,
    weekendSaleTemplate,
    flashSaleTemplate,
